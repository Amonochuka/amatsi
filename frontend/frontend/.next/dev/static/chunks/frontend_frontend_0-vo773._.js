...
function LoginForm({ onSwitchToSignup }) {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const { data, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$frontend$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
...
_s(LoginForm, "LukQszeHZW/0nQ8m/KKgOJ+aWgg=");
_c = LoginForm;
var _c;
...
//# sourceMappingURL=frontend_frontend_0-vo773._.js.map